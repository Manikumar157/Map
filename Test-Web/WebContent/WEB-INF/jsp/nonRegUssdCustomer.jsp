...
function compareDate(from){
    ...
    function validate(){
		...
		function nonRegUssdCustomerDetailsExcel(){

			submitlink("exportToXlsForNonRegUssdCustomer.htm","nonRegUssdCustomerViewForm"); 
		...
		function nonRegUssdCustomerDetailsPDF(){
			 
			 submitlink("exportToPdfForNonRegUssdCustomer.htm","nonRegUssdCustomerViewForm"); 
			 for(var i=0;i<150000;i++);{
		...
		function compareFromDate(fromdt,todt)
		{
	  	...
	  	function searchNonRegUssdCustomer(){	
	 	    ...
	 	    if(fromDate ==""){
	  		 ...
	  		 submitlink("nonRegUssdCustomer.htm","nonRegUssdCustomerViewForm"); 
	  	}
	</script>
</head>
<body onload="check(),check1();">
	...
	<form:form id="nonRegUssdCustomerViewForm" name="nonRegUssdCustomerViewForm" class="form-inline"
		commandName="nonRegUssdCustomerDTO" method="post">
		<jsp:include page="csrf_token.jsp" />
		<div class="col-lg-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title"><span><spring:message code="LABEL_NON_REG_USSD_CUSTOMERS_REPORT" text="Non Registered USSD Customers Report"/></span></h3>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					...
					<form:input id="mobileNumber" path="mobileNumber" type="text" maxlength="12" cssClass="form-control"/> 
				</div>   
			</div>
				<div class="row">
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					...
					<div class="box-footer">
						<input type="button" class="btn btn-primary pull-right" value="<spring:message code="LABEL_SEARCH"/>" id="searchId" onclick="searchNonRegUssdCustomer();" />
						<br /> <br />
					</div>
				...
				<div class="box-body table-responsive">
					...
					<div class="exprt"
						...
						<span style="float: right; margin-right: 8px;"> <a href="#"
							onclick="javascript:nonRegUssdCustomerDetailsExcel();"
							...
							onclick="javascript:nonRegUssdCustomerDetailsPDF();"><img
					...
					<table id="example1" class="table table-bordered table-striped"
						...
						<tbody>
							...
							<c:forEach items="${page.results}" var="nonRegUssdCustomer">
								<c:set var="j" value="${ j+1 }"></c:set>
								<tr>
									<td><c:out value="${nonRegUssdCustomer.MSISDN}" /></td>
									<td><fmt:formatDate pattern="dd-MM-yyyy HH:mm:ss" value="${nonRegUssdCustomer.createdDate}" /></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
