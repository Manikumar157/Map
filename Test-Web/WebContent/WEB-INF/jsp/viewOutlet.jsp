...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
			<span><spring:message code="TITLE_OUTLET_DETAILS" text="Outlet Details"> </spring:message></span>
		</h3>
	</div>
	<form:form id="viewOutletForm">
	<jsp:include page="csrf_token.jsp"/>
	<div class="col-sm-5 col-sm-offset-8">
		<a href="javascript:submitForm('viewOutletForm','editOutlet.htm?outletId=<c:out value="${outletDTO.outletId}"/>')"><strong><spring:message code="EDIT_OUTLET" text="Edit Outlet"> </spring:message></strong></a> |
		<a href="javascript:submitForm('viewOutletForm','searchTerminal.htm?outletId=<c:out value="${outletDTO.outletId}"/>&merchantId=<c:out value="${outletDTO.merchantId}"/>')"><strong><spring:message code="LABLE_TERMINAL" text="Terminals"> </spring:message></strong></a> |
		<a href="javascript:submitForm('viewOutletForm','showMechantOutlets.htm?merchantId=<c:out value="${outletDTO.merchantId}"/>')"><strong><spring:message code="OUTLET_SEARCH" text="Search Outlets"> </spring:message></strong></a>  &nbsp; &nbsp; &nbsp;
	</div><br/>
	<div class="box-body">
			<div class="row">
				<div class="col-sm-6">
					<label class="col-sm-5" style="margin-top:4px;"><spring:message code="LABEL_LOCATION" text="Location"/></label> 
					<div class="col-sm-5" style="margin-top:4px;"><c:out value="${outletDTO.location}" /></div>
				</div>
				<div class="col-sm-6">
					<label class="col-sm-5" style="margin-top:4px;"><spring:message code="LABEL_MOBILE_NO" text="MobileNo.:"></spring:message></label> 
					<div class="col-sm-5" style="margin-top:4px;"><c:out value="${outletDTO.primaryContactMobile}" /> </div>
				</div>
			</div>
				<div class="row">
				<div class="col-sm-6">
					<label class="col-sm-5"><spring:message code="LABEL_CITY" text="City:"/></label>
					<div class="col-sm-5"><c:out value="${outletDTO.cityName}" /></div> 
					
				</div>
				<div class="col-sm-6">
					<label class="col-sm-5" style="margin-top:4px;"><spring:message code="LABEL_QUARTER" text="Quarter:"/></label> 
					<div class="col-sm-5" style="margin-top:4px;"><c:out value="${outletDTO.quarterName}" /></div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<label class="col-sm-5"><spring:message code="LABEL_ADDRESS" text="Address:"/></label> 
					<div class="col-sm-5"><c:out value="${outletDTO.address}" /></div>
				</div>
				<div class="col-sm-6">
					...
					<c:forEach items="${outletDTO.merchantCountry.countryNames}" var="cname">
			...
			<div class="col-sm-6">
					...
					<div class="col-sm-5" style="margin-top:4px;"><c:out value="${outletDTO.primaryeMailAddress}" /></div> 
