...
var Alertmsg={
		...
		function cancelForm(){
		    document.processTransactionForm.action="selectTransactionSupportForm.htm";
		...
		function onSubmit(){
			...
			document.processTransactionForm.action="processSupportTransaction.htm";
			document.processTransactionForm.submit();
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
			<span><spring:message code="TITLE_WELCOME_TRANSACTION_SUPPORT" text="Transaction Support" /> - 
	...
	<form:form method="post" class="form-inline" action="processTransaction.htm" name="processTransactionForm" commandName="accountDetailsDTO">
			...
			<div class="row">
				<div class="col-sm-6">
					<label class="col-sm-5" style="margin-top:4px;"><spring:message code="LABEL_SELECT_ACCOUNT" text="Select Account" /></label>
					<div class="col-sm-5">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<img src="<%=request.getContextPath()%>/getPhoto.htm?type=idproof&customerId=<c:out value="${accountDetailsDTO.customerId}" />" alt="<spring:message code="LABEL_ID_PROOF_NOT_FOUND" text="ID Proof not found"/>" width="50" height="50" /></a>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					...
					<img src="<%=request.getContextPath()%>/getPhoto.htm?type=signature&customerId=<c:out value="${accountDetailsDTO.customerId}" />" alt="<spring:message code="LABEL_SIGNATURE_NOT_FOUND" text="Signature not found" />" width="50" height="50" /></a>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-sm-offset-10">
				...
				<input type="button" class="btn-default btn" value="<spring:message code="LABEL_CANCEL" text="Cancel"/>" onclick="cancelForm();" />
				</div>
			</div><br/><br/>
		</form:form>	
