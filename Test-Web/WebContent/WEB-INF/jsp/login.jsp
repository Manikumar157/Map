...
<script type="text/javascript">
        ...
        function submitForgot(url){
        	...
        	document.loginForm.action ="<%=request.getContextPath()%>/forwardLogin.htm";
            document.loginForm.submit();
        }
							...
							<div class="col-lg-12">
								<div class="account-box">
									...
									<form name="loginForm"
										...
										<input class="btn btn btn-primary" style="border: 1px solid rgba(0, 0, 0, 0.1);" name="Login"
											value="<spring:message code="LABEL_LOGIN" text="Login" />"
											type="button" onclick="checkValidation()" />
											&nbsp;&nbsp;&nbsp;&nbsp;
											<a  style="float:right; cursor: pointer;" onclick="submitForgot('showForgotPasswordForm.htm')"><spring:message
												code="LABEL_FORGET_PASSWORD" text="Forgot Password?" /></a>
									</form>
									<div class="topspace">
