...
<%response.sendRedirect(request.getContextPath()+"/forwardLogin.htm?message=SESSION_EXPIRED "); %>
	<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
	    	<td width="993" align="center" class="copy_rgt"><spring:message code="LABEL_VERSION_COPYRIGHT" text="v"/> ${version }<spring:message code="LABEL_COPYRIGHT" text="Copyright"/> &copy; <spring:message code="LABEL_COPYRIGHT_STRING" text="2019 All Rights Reserved Trinity Technologies"/></td>
	  	</tr>
	</table>
</body>
</html>
