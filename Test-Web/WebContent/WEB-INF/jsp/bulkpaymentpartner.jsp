...
function registerbusinesspartner() {
	if(validate()){
		submitlink("saveBulkPaymentPartner.htm","BusinessPartnerRegistrationForm");
	}
...
function validate(){
	...
	else if(kycImage!="" && imge.size > 3145728) {  // validation according to file size
...
function cancelForm(){
	 clearForm();
	document.BusinessPartnerRegistrationForm.action="bulkpaymentpartnerPartner.htm";
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">			
			...
			<span><spring:message code="LABEL_BULKPAYMENT_PARTNER_SHOWFORM" text="Bulk-Payment Partner"></spring:message></span>
			</c:if>
	...
	<c:if test="${BusinessPartnerDTO.id eq null }">
		<div class="add_cus">					
			<a href="javascript:submitForm('BusinessPartnerRegistrationForm','bulkpaymentpartnerPartner.htm')"><strong style="margin-left: 45px;">
			<c:if test='${roleId eq 2}'>
	 ...
	 <div class="box-body">			
			...
			<authz:authorize ifAnyGranted="ROLE_mGurush,ROLE_bankadmin,ROLE_bankteller">
					...
					<form:option value="2"><spring:message code="LABEL_BUSINESS_PARTNER_L1" text="Business Partner L1"/></form:option>
						...
						<c:if test="${BusinessPartnerDTO.id eq null }">
					<label class="col-sm-5"><spring:message code="LABEL_BULKPARTNER_TYPE" text="Bulk-Payment Partner"/></label>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<form:input path="designation" maxlength="32" cssClass="form-control" ></form:input> 
