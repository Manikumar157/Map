...
<script type="text/javascript">
	...
	function validate() {
		...
		if (isdCode == "") {
			...
			document.transactionForm.action = "getAccountDetails.htm?mobileNumber="
					+ mobileNumber;
	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">
					<span><spring:message
							code="TITLE_WELCOME_TRANSACTION_RECEIPT"
							text="Transaction Services" /></span> <!--Author:Vineeth Reddy /message changed from Transaction to Transaction Services bug no:5341 -->
				</h3>
			</div>
			<br />
			<!-- /.box-header -->
								...
								<td width="100%" height="151" colspan="2" valign="top"><br />
									<table width="97%" align="center" cellpadding="3"
										...
										<tr>
											...
											<td><spring:message code="LABEL_BUSINESS_PARTNER_CODE"
													text="Business Partner Code" />:</td>
