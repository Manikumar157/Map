  ...
  function check(){	
 	...
 	function compareDate(from){
  	...
  	function searchTxnReport(){	  	
         ...
         submitlink("searchTxnMerchantData.htm","txnSummaryform");
...
/* 				setTokenValFrmAjaxResp();
   ...
   return false;
	...
	function misExcel(){
			 ...
			 submitlink("exportToXlsMerchantCommisionReport.htm","txnSummaryform"); 
	...
	function misPDF(){
			 ...
			 submitlink("exportToPdfMerchantCommisionReport.htm","txnSummaryform"); 
			 for(var i=0;i<150000;i++);
			 document.body.style.cursor = 'default';
			 canSubmit = true; 
		}
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
			...
			<span><spring:message code="LABEL_TXN_MERCHANT_REPORT" text="Transaction Merchant Report"/></span>
		</h3>
	</div>
	...
	<div class="box-body">
		...
		<authz:authorize ifAnyGranted="ROLE_admin,ROLE_backofficelea,ROLE_backofficeexe,ROLE_branchmanager"><!--End  -->
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<label class="col-sm-5"><spring:message code="LABEL_AGENT_MERCHANT_CODE" text=" Agent/Merchant Code"/></label>
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<form:select class="dropdown chosen-select" id="transactionType" path="transactionType" >
						<form:option value=""><spring:message code="LABEL_SELECT" text="---Please Select---"/>
						<c:set var="lang" value="${locale}"></c:set></form:option>
						<form:option value="90"><spring:message code="LABEL_TXNTYPE_SALE" text="Sale" /></form:option>
						<form:option value="128"><spring:message code="LABEL_PAY" text="m-GURUSH Pay" /></form:option>
		...
		<%-- <div class="row">
			...
			<div class="row">
				<div class="col-sm-6">
				 ...
				 <div class="col-sm-6">
					<label class="col-sm-5"><spring:message code="Merchant_code" text="Merchant Code"/></label>
					<form:input id="agentCode" path="agentCode" type="text"  cssClass="form-control"/> 
				</div> 
			</div>
			<div class="row">
			...
			<authz:authorize ifAnyGranted="ROLE_superadmin,ROLE_bankadmin">
			...
			<div class="box">
				...
				<div class="exprt" style="margin-bottom: 14px;margin-right: 3px; float:right;" ">
					...
					<span style="margin-right: 6px;">
						<a href="#" onclick="javascript:misExcel();"><img src="<%=request.getContextPath()%>/images/excel.jpg" />
							<%-- <span><spring:message code="LABEL_EXCEL" text="Excel"/></span> --%>
						</a>
					</span>
					
					<span>
					<a href="#"  onclick="javascript:misPDF();"><img src="<%=request.getContextPath()%>/images/pdf.jpg" />
					...
					<table id="txnSummaryData" class="table table-bordered table-striped horizontal-scroll-wrapper">
						<thead>
							<tr>
								...
								<th><spring:message code="Merchant_code" text="Merchant Code"/></th>
								...
								<th><spring:message code="LABEL_MERCHANT_MOBILE_NO" text="Mobile Number"/></th>
								<th><spring:message code="LABEL_CUS_NAME" text="Customer Name" /></th>
								<th><spring:message code="LABEL_CUST_MOBILE" text="Customer Mobile Number"/></th>
								...
								<th><spring:message code="LABEL_SETTLEMENT_AMOUNT" text="Settlement Amount"/></th>
