...
<%-- 	 function printPage() {
	...
	/* function validate() {
		...
		if (businessPartnerCode == "") {
			...
			document.transactionForm.action = "getBusinessPartnerDetails.htm?businessPartnerCode="
					+ businessPartnerCode;
		...
		<div class="box">
			...
			<div class="box-body"
				...
				<form id="selectTransactionForm" class="form-inline"
					action="getBusinessPartnerDetails.htm" method="post" name="transactionForm">
								...
								<td width="100%" height="151" colspan="2" valign="top"><br />
									<table width="97%" align="center" cellpadding="3"
										...
										<tr>
											...
											<c:if test="${transactionReceipt.businessPartnerCode ne null && transactionReceipt.businessPartnerCode ne ''}">
											<td>
											<c:if test="${roleAccess eq 2}">
											<spring:message code="LABEL_BUSINESS_PARTNER_PRINCIPAL_AGENT_CODE"
													text="Principal Agent Code" />:
												</c:if>
											<c:if test="${roleAccess ne 2}">	
											<spring:message code="LABEL_BUSINESS_PARTNER_CODE"
													text="Business Partner Code" />:
													</c:if>		
													</td>
											<td><c:out value="${transactionReceipt.businessPartnerCode}" /></td>
											</c:if>
										</tr>
										<tr>
