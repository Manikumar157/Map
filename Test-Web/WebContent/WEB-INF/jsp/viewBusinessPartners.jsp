...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
			...
			<spring:message code="TITLE_VIEW_PRINCIPAL_AGENTS" text="Principal Agents"></spring:message>
			</c:if>
			<c:if test='${roleId eq 3 || roleId eq 29 || roleId eq 24}'>
	...
	<div class="add_cus">
	<authz:authorize ifAnyGranted="ROLE_addBusinessPartnerAdminActivityAdmin">
		...
		<input type="button" class="btn btn-primary"
							value="<c:if test='${roleId eq 2 || roleId eq 3}'><spring:message code="ADD_PRINCIPAL_AGENT" text="Add Principal Agent"/></c:if><c:if test='${roleId ne 2 && roleId ne 3}'><spring:message code="ADD_BUSINESS_PARTNER" text="Add Super Agent"/></c:if>"
							onclick="javascript:addBusinessPartner('showBusinessPartnerForm.htm')" /> 
	</authz:authorize>
	...
	<authz:authorize ifAnyGranted="ROLE_mGurush,ROLE_bussinesspartnerL1,ROLE_bussinesspartnerL2,ROLE_admin,ROLE_bankadmin,ROLE_bankteller,ROLE_addBusinessPartnerAdminActivityAdmin,ROLE_CommercialOfficer">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<c:if test="${roleId eq 2}">
						<spring:message code="LABEL_PRINCIPAL_AGENT_NAME" text="Principal Agent Name"/>
					</c:if>
					<c:if test="${roleId eq 3 || roleId eq 24}">
					...
					<authz:authorize ifAnyGranted="ROLE_admin,ROLE_mGurush,ROLE_bussinesspartnerL1,ROLE_bussinesspartnerL2,ROLE_bankgroupadmin,ROLE_backofficelea,ROLE_backofficeexe,ROLE_gimsupportlead,ROLE_gimsupportexec,ROLE_bankadmin,ROLE_bankteller,ROLE_addBusinessPartnerAdminActivityAdmin,ROLE_CommercialOfficer">
					<div class="row">	
				<div class="col-sm-6">
				...
				<div class="exprt" style="margin-top: 0px; margin-bottom: 4px; height: 30px;">
					...
					<table id="example1" class="table table-bordered table-striped" style="text-align:center;">
						<thead>
							<tr>
							<c:if test="${roleId eq 2}">
								<th><spring:message code="LABEL_PRINCIPAL_AGENT_CODE" text="Super Agent Code"/></th>
								<th><spring:message code="LABEL_PRINCIPAL_AGENT_NAME" text="Principal Agent Name"/></th>
								<th><spring:message code="LABEL_PRINCIPAL_AGENT_TYPE" text="Principal Agent Type"/></th>
							</c:if>
							<c:if test="${roleId eq 3 || roleId eq 29 || roleId eq 24}">
					            ...
					            <tr>
									...
									<td>
										...
										<authz:authorize ifAnyGranted="ROLE_editBusinessPartnerAdminActivityAdmin">
											...
											<a href="javascript:customerDetailEdit('editBusinessPartner.htm','<c:out value="${bpart.id}"/>')"><spring:message code="LABEL_EDIT" text="Edit" /></a>
										</authz:authorize>
										</authz:authorize>
									</td>
								</tr>
