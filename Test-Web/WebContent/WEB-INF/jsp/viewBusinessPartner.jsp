...
<div class="box">
	...
	<div class="box-header">
		<h3 class="box-title">
			...
			<span><spring:message code="TITLE_PRINCIPAL_AGENT_DETAILS" text="Principal Agent Details "> </spring:message></span>
			</c:if>
	...
	<%-- <c:if test="${BusinessPartnerDTO.id ne null }"> --%>
		<c:if test='${fromDate eq null || fromDate eq ""}'>
		 <div class="col-sm-5 col-sm-offset-9">
			<a href="javascript:submitForm('viewBusinessPartnerForm','businessPartner.htm')"><strong style="margin-left: 75px;">
		...
		<c:if test='${fromDate ne null && fromDate ne ""}'>
		 <div class="col-sm-5 col-sm-offset-8">	
			<a href="javascript:submitForm('viewBusinessPartnerForm','businessPartner.htm')"><strong style="margin-left: 100px;">
				<c:if test='${roleId eq 2 || roleId eq 3}'><spring:message code="LINK_SEARCH_BACK_PRINCIPAL_BUSINESS_PARTNERS" text="Back to Search Principal Agents"> </spring:message></c:if>
				<c:if test='${roleId ne 2 && roleId ne 3}'><spring:message code="LINK_SEARCH_BACK_BUSINESS_PARTNERS" text="Back to Search Super Agents"> </spring:message></c:if>				
				</strong></a>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		</div>
		</c:if>
<%-- 	</c:if> --%>
