...
<body>
  ...
  <c:if test="${currentSubscriptions ne null}">
  <div class="text_align">
   <a href="#" onclick="currentSC();"><spring:message code="LABEL_SERVICE_CHARGE_SUB" text="SC Subscription" /></a>
   </div>
   </c:if>
		...
		<div class="col-lg-12 table_box">
			...
			<div class="row">
				<ul class="header_menu">
					...
					<li class="col-sm-3 sub_bar1"><spring:message code="LABEL_SUBSCRIPTION_TYPE" text="Subscription type" /></li>
					<li class="col-sm-3 sub_bar2"><spring:message code="LABEL_SUBSCRIPTION_COST" text="Subscription Cost" /></li>
					<li class="col-sm-2 sub_bar3"><spring:message code="LABEL_NO_OF_TRANSACTIONS" text="No. Of TXN's" /></li>
			...
			<div class="left_right_content col-lg-12">
					<div class="col-sm-2">
						...
						<c:forEach items="${scPackageList}" var="packageList">
						<!-- /*date:05/08/16 by:rajlaxmi for:showing only subscribed sms packages details*/ -->
						<li class="pkg<c:out value="${packageList.serviceChargeRule.serviceChargeRuleId }"/>"><a href="#" data-toggle="tab"
									onclick="scPackageDetails('<c:out value="${packageList.serviceChargeRule.serviceChargeRuleId }"/>','<c:out value="${customerId}"/>')"><c:out
										value="${packageList.serviceChargeRule.serviceChargeRuleName }"></c:out></a></li>
								<br />
