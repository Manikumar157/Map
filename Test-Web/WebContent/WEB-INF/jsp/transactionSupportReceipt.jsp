...
<script type="text/javascript">
	...
	/*  change vineeth, 26/06/2018, bug no:5309
	 system is not allowing to click at any menu untill unless login again. */
 /* 	function printPage() {
 ...
 function printPage() {
		...
		var toPrint  = '<table width="80%" align="center"><tr><td colspan="2"><img src="images/header_01.jpg" width="900" height="166" border="0" style="align:center"/></td></tr><tr><td colspan="2" align="center"><c:out value="${transactionReceipt.description}" /></td></tr><tr><td style="width:160px"></td><td>'
				+ printContents + '</td></tr></table>';

	 var popupWin = window.open('', '_blank', 'width=750,height=600,location=no,left=200px');
	 popupWin.document.open();
	 popupWin.document.write('<html><head><title>GIM Wallet</title><style>#savePrint, #buttonId{display: none !important;}</style></head><body onload="window.print();window.close();">')
...
<body>
	...
	<!--******************start hidden div***************-->
						...
						<div width="800px" id="LightBox1" class="box_content" style="display: block;">
							...
							<table cellpadding="3" height="300px;" cellspacing="0" width="90%" border="0">
								<tr align="left">
									<td colspan="2" bgcolor="#FFFFFF" style="padding: 10px;">
									<div onclick="displayHideBox('1');"
										...
										<tr>
											<td width="100%" height="151" colspan="2" valign="top"><br />
												...
												<c:if test="${ transactionReceipt.transactionType == 98 }">
													<table width="100%" cellpadding="3" cellspacing="3">
														<tr>
															<td align="center"><a href="generatePDFTxnStatement.htm" ><b><br /><spring:message code="LABEL_CLICK_DOWNLOAD" text="Click to download" /></a> </td>
														</tr>
													</table>
												</c:if>
												<c:if test="${ transactionReceipt.transactionType != 98 }">
												<table style="display: block;" width="100%" cellpadding="3" cellspacing="3" id="savePrint">
														<tr>
															<td align="left"><a href="saveTxnStatement.htm" ><b><spring:message code="LABEL_SAVE" text="Save" /></a> </td>
															<td align="right" style="width: 93%;">&nbsp;</td>
															<td ><a href="javascript:printPage();" ><b><spring:message code="LABEL_PRINT" text="Print" /></a> </td>
														</tr>
												</table>
											  </c:if>
