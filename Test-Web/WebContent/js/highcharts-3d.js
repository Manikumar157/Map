...
(function(D) {
    ...
    (function(a) {
        ...
        a.perspective = function(p, n, u) {
            var m = n.options.chart.options3d,
                ...
                r = n.plotHeight / 2,
                d = m.depth / 2,
                e = k(m.depth, 1) * k(m.viewDistance, 0),
                c = n.scale3d || 1,
                b = q * m.beta * (f ? -1 : 1),
                m = q * m.alpha * (f ? -1 : 1),
                h = Math.cos(m),
            ...
            return a.map(p, function(b) {
                ...
                b = -x * y * m + h * n - v * x * k;
                m = h * y * m + x * n + h * v * k;
                n = 0 < e && e < Number.POSITIVE_INFINITY ? e / (m + d + e) : 1;
                a = a * n * c + g;
                b = b * n * c + r;
                return {
                    x: f ? b : a,
    ...
    (function(a) {
        function q(b) {
            var a = 0,
                l, c;
            for (l = 0; l < b.length; l++) c = (l + 1) % b.length, a += b[l].x * b[c].y -
                b[c].x * b[l].y;
            return a / 2
        }
        ...
        function p(b, c, l, a, h, d, F, e) {
            var f = [],
                H = d - h;
            return d > h && d - h > Math.PI / 2 + .0001 ? (f = f.concat(p(b, c, l, a, h, h + Math.PI / 2, F, e)), f = f.concat(p(b, c, l, a, h + Math.PI / 2, d, F, e))) : d < h && h - d > Math.PI / 2 + .0001 ? (f = f.concat(p(b, c, l, a, h, h - Math.PI / 2, F, e)), f = f.concat(p(b, c, l, a, h - Math.PI / 2, d, F, e))) : ["C", b + l * Math.cos(h) - l * t * H * Math.sin(h) + F, c + a * Math.sin(h) + a * t * H * Math.cos(h) + e, b + l * Math.cos(d) + l * t * H * Math.sin(d) + F, c + a * Math.sin(d) -
        ...
        G.prototype.cuboidPath = function(b) {
            ...
            var a = b.x,
                ...
                m = y(m, g[this.chartIndex], b.insidePlotArea),
                d = function(b, a) {
                    var h = [];
                    b = v(b, c);
                    a = v(a, c);
            ...
            h = d([1, 6, 7, 0], a);
            d = d([1, 2, 5, 6], [0, 7, 4, 3]);
            return [this.toLinePath(b, !0), this.toLinePath(h, !0), this.toLinePath(d, !0), k(b), k(h), k(d), 9E9 * k(v(a, c))]
        };
        a.SVGRenderer.prototype.arc3d = function(a) {
            function d(b) {
                var a = !1,
                    c = {},
                    d;
                for (d in b) - 1 !== h(d, v) && (c[d] = b[d], delete b[d], a = !0);
                return a ? c : !1
            }
            var l = this.g(),
                m = l.renderer,
                v = "x y r innerR start end".split(" ");
            a = x(a);
            a.alpha *= e;
            a.beta *= e;
            l.top = m.path();
            ...
            B(l, "animate", function(b, a, c, h) {
                ...
                delete a.alpha;
                delete a.beta;
                m = f(E(c, this.renderer.globalAnimation));
                m.duration && (a = x(a), l = d(a), a.dummy = 1, l && (m.step = function(b, a) {
                    function c(b) {
                        return e[b] + (E(l[b], e[b]) - e[b]) * a.pos
                    }
                    "dummy" ===
                    a.prop && a.elem.setPaths(x(e, {
                        x: c("x"),
                        y: c("y"),
                        r: c("r"),
                        innerR: c("innerR"),
        ...
        G.prototype.arc3dPath = function(b) {
            ...
            var y = Math.sin(e),
                ...
                z = v * Math.sin(g),
                v = ["M", c + w * x, h + f * q],
                v = v.concat(p(c, h, w, f, d, e, 0, 0)),
                v = v.concat(["L", c + t * b, h + B * y]),
                v = v.concat(p(c, h, t, B, e, d, 0, 0)),
                v = v.concat(["Z"]),
                E = 0 < k ? Math.PI / 2 : 0,
                k = 0 <
                g ? 0 : Math.PI / 2,
                E = d > -E ? d : e > -E ? -E : d,
                C = e < u - k ? e : d < u - k ? u - k : e,
                A = 2 * u - k,
                g = ["M", c + w * n(E), h + f * m(E)],
                g = g.concat(p(c, h, w, f, E, C, 0, 0));
            e > A && d < A ? (g = g.concat(["L", c + w * n(C) + r, h + f * m(C) + z]), g = g.concat(p(c, h, w, f, C, A, r, z)), g = g.concat(["L", c + w * n(A), h + f * m(A)]), g = g.concat(p(c, h, w, f, A, e, 0, 0)), g = g.concat(["L", c + w * n(e) + r, h + f * m(e) + z]), g = g.concat(p(c, h, w, f, e, A, r, z)), g = g.concat(["L", c + w * n(A), h + f * m(A)]), g = g.concat(p(c, h, w, f, A, C, 0, 0))) : e > u - k && d < u - k && (g = g.concat(["L", c + w * Math.cos(C) + r, h + f * Math.sin(C) + z]), g = g.concat(p(c, h, w, f, C, e,
                r, z)), g = g.concat(["L", c + w * Math.cos(e), h + f * Math.sin(e)]), g = g.concat(p(c, h, w, f, e, C, 0, 0)));
            g = g.concat(["L", c + w * Math.cos(C) + r, h + f * Math.sin(C) + z]);
            g = g.concat(p(c, h, w, f, C, E, r, z));
            g = g.concat(["Z"]);
            k = ["M", c + t * x, h + B * q];
            k = k.concat(p(c, h, t, B, d, e, 0, 0));
            k = k.concat(["L", c + t * Math.cos(e) + r, h + B * Math.sin(e) + z]);
            k = k.concat(p(c, h, t, B, e, d, r, z));
            k = k.concat(["Z"]);
            x = ["M", c + w * x, h + f * q, "L", c + w * x + r, h + f * q + z, "L", c + t * x + r, h + B * q + z, "L", c + t * x, h + B * q, "Z"];
            c = ["M", c + w * b, h + f * y, "L", c + w * b + r, h + f * y + z, "L", c + t * b + r, h + B * y + z, "L", c + t * b, h + B * y, "Z"];
            y = Math.atan2(z, -r);
            h = Math.abs(e + y);
            b = Math.abs(d + y);
            d = Math.abs((d + e) / 2 + y);
    ...
    (function(a) {
        function q(a, d) {
            ...
            e > r && (t = Math.min(t, 1 - Math.abs((e + f) / (r + f)) % 1));
            c < m && (t = Math.min(t, (c - f) / (m - f)));
            b > k && (t = 0 > k ? Math.min(t, (b + g) / (-k + b + g)) : Math.min(t, 1 - (b + g) / (k + g) % 1));
            h < n && (t = Math.min(t, Math.abs((h - g) / (n - g))));
            return t
        }
        var k = a.Chart,
            p = a.each,
        ...
        f(k.prototype, "setClassName", function(a) {
        ...
        k.prototype.retrieveStacks = function(a) {
            ...
            p(this.series, function(h) {
                c = m(h.options.stack, a ? 0 : d.length - 1 - h.index);
        ...
        e(k.prototype, "render", function(a) {
            ...
            if (this.chart.is3d()) {
                ...
                this.isZAxis || (this.horiz ? (g = {
                    x: n,
                    y: p + (b.xAxis[0].opposite ? -f.size : m),
                    z: 0,
                    width: r,
                    height: f.size,
                    depth: k,
                    ...
                    x: n + (b.yAxis[0].opposite ? 0 : -e.size),
                    y: p + (b.xAxis[0].opposite ? -f.size : 0),
                    z: k,
                    width: r + e.size,
                    height: m + f.size,
                    depth: g.size,
                    ...
                    x: n + (b.yAxis[0].opposite ? r : -e.size),
                    y: p + (b.xAxis[0].opposite ? -f.size : 0),
                    z: 0,
                    width: e.size,
                    height: m + f.size,
        ...
        u(q.prototype, {
            ...
            getSeriesExtremes: function() {
                ...
                n(a.series, function(c) {
                    if (c.visible || !b.options.chart.ignoreHiddenSeries) a.hasVisibleSeries = !0, c = c.zData, c.length && (a.dataMin = Math.min(g(a.dataMin, c[0]), Math.min.apply(null, c)), a.dataMax = Math.max(g(a.dataMax, c[0]), Math.max.apply(null, c)))
                })
            }
        });
    ...
    (function(a) {
        ...
        function k(a) {
            if (this.chart.is3d()) {
                ...
                void 0 === d || d || void 0 === this.group.zIndex || this.zIndexSet || (this.group.attr({
        ...
        a(f.column.prototype, "pointAttribs", q);
        f.columnrange && a(f.columnrange.prototype, "pointAttribs", q);
        a(m.prototype, "alignDataLabel", function(a) {
            if (this.chart.is3d() && ("column" === this.type || "columnrange" === this.type)) {
                var d = arguments[4],
                    ...
                    e = n([e], this.chart, !0)[0];
                d.x = e.x;
                d.y = e.y
            }
            a.apply(this, [].slice.call(arguments, 1))
        });
        f.columnrange && a(f.columnrange.prototype, "drawPoints", k);
    ...
    (function(a) {
        ...
        a(n.pie.prototype, "translate", function(a) {
            ...
            if (this.chart.is3d()) {
                var f = this,
                    ...
                    e = d.alpha,
                    c = d.beta,
                    b = g.stacking ? (g.stack || 0) * m : f._i * m,
                    b = b + m / 2;
                !1 !== g.grouping && (b = 0);
                k(f.data, function(a) {
                    var d = a.shapeArgs;
                    ...
                    d = (d.end + d.start) / 2;
                    a.slicedTranslation = {
                        translateX: Math.round(Math.cos(d) * g.slicedOffset * Math.cos(e * q)),
                        translateY: Math.round(Math.sin(d) *
                            g.slicedOffset * Math.cos(e * q))
                    }
                })
            }
        });
        a(n.pie.prototype.pointClass.prototype, "haloPath", function(a) {
            var f = arguments;
            return this.series.chart.is3d() ? [] : a.call(this, f[1])
        });
        a(n.pie.prototype, "pointAttribs", function(a, f, g) {
            a = a.call(this, f, g);
            g = this.options;
            this.chart.is3d() && (a.stroke = g.edgeColor || f.color || this.color, a["stroke-width"] = p(g.edgeWidth, 1));
            return a
        });
        ...
        a(n.pie.prototype, "drawDataLabels", function(a) {
            if (this.chart.is3d()) {
                ...
                k(this.data, function(a) {
                    var g = a.shapeArgs,
                        ...
                        e = (g.start + g.end) / 2,
                        c = a.labelPos,
                        b = -d * (1 - Math.cos((g.alpha || f.alpha) * q)) * Math.sin(e),
                        h = d * (Math.cos((g.beta || f.beta) * q) - 1) * Math.cos(e);
                    k([0, 2, 4], function(a) {
                        c[a] += h;
                        c[a + 1] += b
                    })
    ...
    (function(a) {
        ...
        u(n.scatter.prototype, "translate", function(a) {
            ...
            if (this.chart.is3d()) {
                var f = this.chart,
                    ...
                    m = [],
                    d, e, c;
                for (c = 0; c < this.data.length; c++) d = this.data[c], e = g.isLog && g.val2lin ? g.val2lin(d.z) : d.z, d.plotZ = g.translate(e), d.isInside = d.isInside ? e >= g.min && e <= g.max : !1, m.push({
                    x: d.plotX,
                    y: d.plotY,
                    z: d.plotZ
                });
        ...
        u(n.scatter.prototype, "init", function(a, f, g) {
            f.is3d() && (this.axisTypes = ["xAxis", "yAxis", "zAxis"], this.pointArrayMap = ["x", "y", "z"], this.parallelArrays = ["x", "y", "z"], this.directTouch = !0);
            a = a.apply(this, [f, g]);
        ...
        u(n.scatter.prototype, "pointAttribs", function(k, f) {
